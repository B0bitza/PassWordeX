...
class connectMySQL:
    ...
    #insert into report_tb (tip_report,descriere_report) values ('Problema cu parola','Parola nu merge');
    def insert_report(self,tip_report,descriere_report):
        sql = f"INSERT INTO report_tb (tip_report,descriere_report) VALUES ('{tip_report}', '{descriere_report}')"
        result = self.update_data(sql=sql)
        return result
