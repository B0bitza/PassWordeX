...
from ui.reportDialog import Ui_Dialog
import os
...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(1144, 649)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icon/icon/favicon.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}\n"
"\n"
"#generateShowBtn:hover, #generateShowBtn:pressed\n"
"{\n"
...
"")
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/icon/icon/redo-5-128.gif"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.showRefreshBtn.setIcon(icon1)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/icon/icon/search-7-128.gif"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.showSearchBtn.setIcon(icon2)
        ...
        self.generateRestBtn.setIcon(icon1)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/icon/icon/pressure-128.gif"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.generateCreateBtn.setIcon(icon3)
        ...
        spacerItem2 = QtWidgets.QSpacerItem(744, 426, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.gridLayout_6.addItem(spacerItem2, 9, 0, 1, 2)
        self.generateShowBtn = QtWidgets.QPushButton(self.page_2)
        self.generateShowBtn.setMinimumSize(QtCore.QSize(0, 32))
        self.generateShowBtn.setMaximumSize(QtCore.QSize(16777215, 32))
        ...
        self.generateShowBtn.setMaximumSize(QtCore.QSize(16777215, 32))
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/icon/icon/copy-128.gif"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.generateShowBtn.setIcon(icon4)
        self.generateShowBtn.setObjectName("generateShowBtn")
        self.gridLayout_6.addWidget(self.generateShowBtn, 4, 0, 1, 2)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/icon/icon/copy-128.gif"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.generateCopyBtn.setIcon(icon4)
        self.generateCopyBtn.setObjectName("generateCopyBtn")
        self.gridLayout_6.addWidget(self.generateCopyBtn, 8, 0, 1, 1)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/icon/icon/save-128.gif"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.generateSaveBtn.setIcon(icon5)
        self.generateSaveBtn.setObjectName("generateSaveBtn")
        self.gridLayout_6.addWidget(self.generateSaveBtn, 8, 1, 1, 1)
...
"}")
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/icon/icon/edit-property-48.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.confEditBtn.setIcon(icon6)
        ...
        self.confRefreshBtn.setIcon(icon1)
        ...
        self.confSaveBtn.setIcon(icon5)
        ...
        self.label_10 = QtWidgets.QLabel(self.menuWidget)
        palette = QtGui.QPalette()
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/icon/icon/key-4-128.gif"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon7.addPixmap(QtGui.QPixmap(":/icon/icon/key-4-48-checked.ico"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/icon/icon/generic-text-48.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon8.addPixmap(QtGui.QPixmap(":/icon/icon/generic-text-48-checked.ico"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/icon/icon/data-configuration-128.gif"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon9.addPixmap(QtGui.QPixmap(":/icon/icon/data-configuratio-checkedn-48.ico"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.pushButton_3.setIcon(icon9)
        self.pushButton_3.setCheckable(True)
        self.pushButton_3.setAutoExclusive(True)
        self.pushButton_3.setObjectName("pushButton_3")
        self.verticalLayout.addWidget(self.pushButton_3)
        self.pushButton_6 = QtWidgets.QPushButton(self.menuWidget)
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(":/icon/icon/pressure-128 (1).gif"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_6.setIcon(icon10)
        self.pushButton_6.setObjectName("pushButton_6")
        self.pushButton_6.clicked.connect(self.openReportDialog)
        self.verticalLayout.addWidget(self.pushButton_6)
        self.pushButton_5 = QtWidgets.QPushButton(self.menuWidget)
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(":/icon/icon/show-property-128.gif"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_5.setIcon(icon11)
        self.pushButton_5.setObjectName("pushButton_5")
        self.pushButton_5.clicked.connect(self.openPdf)
        self.verticalLayout.addWidget(self.pushButton_5)
        self.pushButton_4 = QtWidgets.QPushButton(self.menuWidget)
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap(":/icon/icon/arrow-208-48.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_4.setIcon(icon12)
        self.pushButton_4.setObjectName("pushButton_4")
        self.pushButton_4.clicked.connect(self.openAboutDialog)
        self.verticalLayout.addWidget(self.pushButton_4)
        spacerItem4 = QtWidgets.QSpacerItem(20, 574, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.verticalLayout.addItem(spacerItem4)
...
"")
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap(":/icon/icon/logout-48.ico"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.exitBtn.setIcon(icon13)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "PassWordeX"))
        MainWindow.setWindowIcon(QtGui.QIcon(':/icon/icon/favicon.ico'))
        self.label.setText(_translate("MainWindow", "Nume utilizator"))
        self.showRefreshBtn.setText(_translate("MainWindow", "Refresh"))
        self.label_2.setText(_translate("MainWindow", "Website"))
        self.showSearchBtn.setText(_translate("MainWindow", "Cauta"))
        ...
        item.setText(_translate("MainWindow", "Nume utilizator"))
        item = self.tableWidget.horizontalHeaderItem(4)
        item.setText(_translate("MainWindow", "Parola"))
        item = self.tableWidget.horizontalHeaderItem(5)
        item.setText(_translate("MainWindow", "Operatie"))
        ...
        self.generateRestBtn.setText(_translate("MainWindow", "Reseteaza"))
        self.generateCreateBtn.setText(_translate("MainWindow", "Generare parola"))
        self.label_3.setText(_translate("MainWindow", "Website"))
        self.label_4.setText(_translate("MainWindow", "Nume utilizator"))
        self.label_5.setText(_translate("MainWindow", "Lungime"))
        self.checkBox.setText(_translate("MainWindow", "Majuscule"))
        self.checkBox_2.setText(_translate("MainWindow", "Numere"))
        self.checkBox_3.setText(_translate("MainWindow", "Caractere speciale"))
        self.generateShowBtn.setText(_translate("MainWindow", "Arata parola"))
        self.generateCopyBtn.setText(_translate("MainWindow", "Copiaza"))
        self.generateSaveBtn.setText(_translate("MainWindow", "Salveaza"))
        self.generatePWLineEdit.setPlaceholderText(_translate("MainWindow", "Parola"))
        self.label_6.setText(_translate("MainWindow", "Litere mici"))
        self.lineEdit_6.setPlaceholderText(_translate("MainWindow", "abcdefghijklmnopqrstuvwxyz"))
        self.label_7.setText(_translate("MainWindow", "Majuscule"))
        self.lineEdit_7.setPlaceholderText(_translate("MainWindow", "ABCDEFGHIJKLMNOPQRSTUVWXYZ"))
        self.label_8.setText(_translate("MainWindow", "Numere"))
        self.lineEdit_8.setPlaceholderText(_translate("MainWindow", "1234567890"))
        self.label_9.setText(_translate("MainWindow", "Caractere speciale"))
        self.lineEdit_9.setPlaceholderText(_translate("MainWindow", "@#$%&^!"))
        self.confEditBtn.setText(_translate("MainWindow", "Editeaza"))
        self.confRefreshBtn.setText(_translate("MainWindow", "Refresh"))
        self.confSaveBtn.setText(_translate("MainWindow", "Salveaza"))
        self.label_10.setText(_translate("MainWindow", "PassWordeX"))
        self.pushButton.setText(_translate("MainWindow", "Date salvate"))
        self.pushButton_2.setText(_translate("MainWindow", "Introdu datele"))
        self.pushButton_3.setText(_translate("MainWindow", "Configuratie parola"))
        self.pushButton_6.setText(_translate("MainWindow", "Raporteaza o problema"))
        self.pushButton_5.setText(_translate("MainWindow", "Manual utilizator"))
        self.pushButton_4.setText(_translate("MainWindow", "Despre aplicatie"))
