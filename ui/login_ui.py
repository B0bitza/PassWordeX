...
"")
        ...
        spacerItem2 = QtWidgets.QSpacerItem(111, 835, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout.addItem(spacerItem2, 0, 0, 2, 1)
        spacerItem3 = QtWidgets.QSpacerItem(110, 835, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        ...
        spacerItem4 = QtWidgets.QSpacerItem(20, 129, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        ...
        self.gridLayout_2.addWidget(self.exitBtn, 2, 2, 1, 1)
...
"}")
        ...
        spacerItem11 = QtWidgets.QSpacerItem(79, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        ...
        self.gridLayout_3.addWidget(self.backBtn, 2, 1, 1, 1)
    ...
    def retranslateUi(self, Form):
        ...
        self.titleLabel1.setText(_translate("Form", "PassWordeX"))
        self.exitBtn.setText(_translate("Form", "Iesire"))
        self.loginLabel.setText(_translate("Form", "Bine ai revenit!"))
        self.label.setText(_translate("Form", "Nume baza de date"))
        self.label_2.setText(_translate("Form", "Parola master"))
        self.registerBtn.setText(_translate("Form", "Creeaza alta baza de date"))
        self.loginBtn.setText(_translate("Form", "Continua"))
        self.registerLabel.setText(_translate("Form", "Creeaza o baza de date noua"))
        self.label_3.setText(_translate("Form", "Numele"))
        self.label_4.setText(_translate("Form", "Parola master"))
        self.createBtn.setText(_translate("Form", "Creeaza"))
        self.backBtn.setText(_translate("Form", "Inapoi"))
